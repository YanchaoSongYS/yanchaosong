...
summary: The study employed data from the i-DREAMS naturalistic driving experiment to develop an individual driving risk assessment framework, consisting of the following steps (1) identification of risky driving scenarios, (2) assessment of individual driving risks, and (3) analysis of the differences in driving risks for various groups of drivers to identify characteristics associated with high-risk drivers.
